			...
			<div style="width: 100%; display: flex;flex-direction: column;align-items: center; background-color: #F2F1ED;">
					...
					<span style="white-space: pre-wrap;">
						...
						<div v-if="seen_id==1" style="display: inline-block;">
							<label style="float:left">产品ID</label> <input v-model="input_val[8]" style="border:0.5px solid #378888; white-space: pre-wrap;">
							<span v-html="'<br>'"></span>
							<label style="float:left">设备名(英文逗号分割)：</label> <input v-model="input_val[0]" style="border:0.5px solid #378888; white-space: pre-wrap;">
